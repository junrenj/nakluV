...
void URenderPipelines::FShadowPipeline::Create(RTG &rtg, VkRenderPass render_pass, uint32_t subpass, VkDescriptorSetLayout TransformsLayout) 
{
...
void URenderPipelines::FShadowPipeline::Destroy(RTG &rtg) 
{
