...
#include "../../spv/Main/Pipelines/lines.vert.inl"
;

static uint32_t frag_code[] =
#include "../../spv/Main/Pipelines/lines.frag.inl"
;

void URenderPipelines::FLinesPipeline::Create(RTG &rtg, VkRenderPass render_pass, uint32_t subpass) {
...
void URenderPipelines::FLinesPipeline::Destroy(RTG &rtg) 
{
