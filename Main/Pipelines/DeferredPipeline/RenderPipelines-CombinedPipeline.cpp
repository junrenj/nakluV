#include "RenderPipelines-CombinedPipeline.hpp"
...
#include "../../../spv/Main/Pipelines/DeferredPipeline/deferred-combined.vert.inl"
;

static uint32_t frag_code[] =
#include "../../../spv/Main/Pipelines/DeferredPipeline/deferred-combined.frag.inl"
;

void FDeferredCombinedPipeline::Create(
    RTG &rtg, 
    VkRenderPass RenderPass, uint32_t Subpass, 
    VkDescriptorSetLayout WorldLayout, 
    VkDescriptorSetLayout EnvTexLayout)
{
    VkShaderModule vert_module = rtg.helpers.create_shader_module(vert_code);
    VkShaderModule frag_module = rtg.helpers.create_shader_module(frag_code);

    Set1_World = WorldLayout;
    Set2_EnvTex = EnvTexLayout;
    
    // set 0: gbuffer textures + Direct Lighting Buffer
    {
    ...
    // Set3 Screen Processing 
    {
        ...
        VK(vkCreateDescriptorSetLayout(rtg.device, &create_info, nullptr, &Set3_ScreenProcess));
    }
...
void FDeferredCombinedPipeline::Destroy(RTG &rtg)
{
