...
layout(set=3,binding=1) uniform samplerCube IRRADIANCE_TEX;
layout(set=3,binding=2) uniform sampler2D LUT_TEX;
...
void main()
{
    ...
    {
        vec3 direct = CalDirectLightings(worldPos, N, V, R, albedo, rough, metal);
