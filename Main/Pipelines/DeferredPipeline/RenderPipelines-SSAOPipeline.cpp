#include "RenderPipelines-SSAOPipeline.hpp"

#include "../../../RTG.hpp"
#include "../../../VK.hpp"

static uint32_t vert_code[] =
#include "../../../spv/Main/Pipelines/DeferredPipeline/deferred-SSAO.vert.inl"
;

static uint32_t frag_code[] =
#include "../../../spv/Main/Pipelines/DeferredPipeline/deferred-SSAO.frag.inl"
;

void FDeferredSSAOPipeline::Create(RTG &rtg, VkRenderPass RenderPass, uint32_t Subpass)
{
...
void FDeferredSSAOPipeline::Destroy(RTG &rtg)
{
