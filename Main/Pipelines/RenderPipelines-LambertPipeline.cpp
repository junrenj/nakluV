...
#include "../../spv/Main/Pipelines/lambert.vert.inl"
;

static uint32_t frag_code[] =
#include "../../spv/Main/Pipelines/lambert.frag.inl"
;

void URenderPipelines::FLambertPipeline::Create(RTG &rtg, VkRenderPass render_pass, uint32_t subpass) {
...

    {
        ...
        VkGraphicsPipelineCreateInfo create_info {
            ...
            .pStages = stages.data(),
            .pVertexInputState = &FVertexDataSet::ArrayInputState,
...
void URenderPipelines::FLambertPipeline::Destroy(RTG &rtg) 
{
