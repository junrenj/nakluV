...
#include "../../spv/Main/Pipelines/background.vert.inl"
;

static uint32_t frag_code[] =
#include "../../spv/Main/Pipelines/background.frag.inl"
;

void URenderPipelines::FBackgroundPipeline::Create(RTG &rtg, VkRenderPass render_pass, uint32_t subpass) {
...
void URenderPipelines::FBackgroundPipeline::Destroy(RTG &rtg) {
