...
static std::array< VkVertexInputAttributeDescription, 2 > Attributes
{
    VkVertexInputAttributeDescription
    {
        ...
        .offset = offsetof(FDebugColVertex, Position),
    },
    VkVertexInputAttributeDescription
    {
        .location = 1,
        ...
        .offset = offsetof(FDebugColVertex, Color),
    },
};

const VkPipelineVertexInputStateCreateInfo FDebugColVertex::ArrayInputState
{
