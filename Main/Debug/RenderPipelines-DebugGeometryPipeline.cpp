...
#include "../../spv/Main/Debug/Shaders/gbuffer-debug.vert.inl"
;

static uint32_t frag_code[] =
#include "../../spv/Main/Debug/Shaders/gbuffer-debug.frag.inl"
;

void FGBufferDebugPipeline::Create(RTG &rtg, VkRenderPass RenderPass, uint32_t Subpass)
{
...
void FGBufferDebugPipeline::Destroy(RTG &rtg)
{
